...
public class ActivityAdapterFactory extends AdapterFactoryImpl {
	...
	protected ActivitySwitch<Adapter> modelSwitch =
		new ActivitySwitch<Adapter>() {
			...
			@Override
			public Adapter caseRes_Alloc(Res_Alloc object) {
				return createRes_AllocAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link activity.ResourceType <em>Resource Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link activity.Res_Alloc <em>Res Alloc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
