...
/**
 * This is the item provider adapter for a {@link activity.ResourceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivityPackage.Literals.RESOURCE_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_resource_feature", "_UI_ResourceType_type"),
				 ActivityPackage.Literals.RESOURCE_TYPE__RESOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ResourceType.class)) {
			case ActivityPackage.RESOURCE_TYPE__NAME:
